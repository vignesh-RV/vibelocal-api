...
from controllers.orders import create_order, delete_order, get_all_orders, get_all_orders_by_user_id, get_order, update_order
...
from controllers.shops import create_shop, delete_shop, get_all_shops, get_shop, get_shop_by_user_id, update_shop
...
from controllers.cart_items import create_cart_item, delete_cart_items, get_cart_items_by_user, get_cart_item, update_cart_item, delete_cart_item
...
app.route("/cart_items/delete", methods=["POST"])(delete_cart_items)
...
app.route("/shops/by_user/<int:user_id>", methods=["GET"])(get_shop_by_user_id)
...
app.route("/orders/<int:user_id>", methods=["GET"])(get_all_orders_by_user_id)
